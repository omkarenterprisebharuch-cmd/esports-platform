/**
 * Organizer Reject User Deposit Request API
 * POST /api/organizer/deposit-requests/[id]/reject
 * 
 * Organizer rejects user's deposit request
 */
...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    if (depositRequest.request_type !== "user_to_organizer") {
      return errorResponse("Invalid request type for organizer rejection", 400);
    }
    ...
    console.error("Reject user deposit request error:", error);
