...
// SSL certificate handling is done via the pool config ssl.rejectUnauthorized option
// Do NOT set NODE_TLS_REJECT_UNAUTHORIZED globally as it affects all TLS connections
